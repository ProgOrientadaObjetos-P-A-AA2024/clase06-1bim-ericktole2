 ...
 * @author reroes
 */
public class ManejoArrayList01 {
    public static void main(String[] args) {
        ...
        for (int i = 0; i < profesores2.size(); i++) {
            System.out.printf("%s - \n", profesores2.get(i));
            // asignamos el valor de proferores den la posision i al objeto que
            // creamos reciente mente llamado p1, eto lo hacermos para agilizar 
            // procesos y hacerlo mas legible
        }
    }
}
